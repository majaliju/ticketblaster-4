  ...
  return (
    <div>
      <footer class='text-white bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500'>
        <div class='px-4 pt-32 pb-12 mx-auto max-w-screen-xl sm:px-6 lg:px-8'>
          ...
          <div class='pt-12 mt-32 border-t border-white/25 sm:items-center sm:justify-between sm:flex'>
            <nav class='flex justify-center text-sm font-medium gap-4 sm:justify-start'>
            ...
            <div class='flex justify-center mt-6 gap-6 sm:justify-end sm:mt-0'>
              <a
